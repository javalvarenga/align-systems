...
function Cap6() {
  return (
    <div className="Cap6">
      <h3>
        <b>Capítulo 6-Marketing</b>
      </h3>
      <div className="contenido">
        <p>
          De acuerdo con la Asociación Estadounidense de Marketing, la función
          de marketing comprende la planeación y práctica de actividades de
        ...
        <ol>
          <li>
            <b>Clientes que utilizan y pagan</b>
          </li>
          <li>
            <b>Clientes que utilizan y no pagan</b>
          </li>
          <li>
            <b>Clientes que no utilizan y pagan</b>
          </li>
        </ol>
        <h5>
          <i>
