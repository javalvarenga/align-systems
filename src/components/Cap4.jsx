...
function Cap4() {
  return (
    <div className="Cap4">
      <h3>
        <b>Capítulo 4-Planeación y estrategia</b>
      </h3>
      <div className="contenido">
        <p>
          La estrategia define la dirección de la compañía y la forma de
          competir con otras empresas. La planeación estratégica es el proceso
          de tomar decisiones con respecto a la estrategia de la empresa. Todos
          los negocios cuentan con una estrategia y una planeación estratégica,
          ya sea de forma explícita o implícita. Pasos para planeacion
          estrategica:
        </p>
        <ol>
          <li>
          ...
          <li>
            ...
            encontrar sus fortalezas y debilidades, con las cuales usted
            pretende enfrentar las amenazas y aprovechar las conveniencias.
          </li>
        ...
        <p>
          ...
          las opiniones de los proveedores y en las reclamaciones de los
          clientes.
        </p>
        <h5>
        ...
        <p>
          Identifique a los clientes (o los segmentos de mercado) y el volumen
          de negocios que tienen con la empresa.
        </p>
        <h5>
          <i>Participación de los productos y servicios en la facturación</i>
        </h5>
        <p>
          Identifique el volumen de ventas de cada producto o servicio en
          relación con el total de sus ventas.{" "}
        </p>
        <h5>
          <i>Participación en el mercado</i>
        </h5>
        <p>
          Uno de los principales indicadores de desempeño de la empresa es la
          participación en el mercado.
        </p>
        <img src={img1} alt="" />
      </div>
    </div>
